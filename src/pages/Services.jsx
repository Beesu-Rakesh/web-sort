...
const Services = () => {
    return (
      ...
      <main className="relative overflow-hidden bg-cover" style={{ backgroundImage: `url(${ServicesBg})`}}>
        ...
        <div className='service-container'>
          <img src={WebDesign} alt="uiux-image" className='services-image order-1 ml-12'/>
        ...
        <div className='service-container'>
          <img src={AppDevelopment} alt="uiux-image" className='services-image'/>
          <div className='ml-12 mt-3 hidden md:block'>
        ...
        <div className='service-container'>
          <img src={DigitalMarheting} alt="uiux-image" className='services-image order-1 ml-12'/>
          <div className='mt-3 hidden md:block'>
